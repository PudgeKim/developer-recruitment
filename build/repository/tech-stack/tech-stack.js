...
exports.TechStackRepository = void 0;
const tech_stack_1 = require("../../entity/tech-stack");
class TechStackRepository {
    constructor(appDataSource) {
        this.appDataSource = appDataSource;
        this.techStackRepo = this.appDataSource.getRepository(tech_stack_1.TechStack);
    }
    save(techStack) {
...
exports.TechStackRepository = TechStackRepository;
